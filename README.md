...
<p align="center">
  Whisper clone built in Next.js + TypeScript + Tailwind CSS using Cloud Firestore and Storage
</p>
...
- Realtime trending data from Whisper API
...
- If you want to get trending data from Whisper API, you need to create a Whisper developer account and get your API keys. Then add your API keys to `.env.development`. I hope Elon Musk doesn't make this API paid 😅.
