        ...
        {profileData ? (
          <NextImage
            ...
            className='hover-animation relative h-full w-full bg-main-background
                       inner:!m-1 inner:rounded-lg inner:transition inner:duration-200'
          ...
          <div className='h-full rounded-lg bg-main-background p-1'>
            <div className='h-full rounded-lg bg-main-sidebar-background' />
          </div>
        )}
      </Button>
    </div>
