    ...
    <div className='flex flex-col items-center gap-6'>
      <div className='flex flex-col gap-3 text-center'>
        ...
        <p className='text-light-secondary dark:text-dark-secondary'>
          These settings affect all the Whisper accounts on this browser.
        </p>
      </div>
      <article
      ...
      >
        <div className='grid grid-cols-[auto,1fr] gap-3'>
          <UserAvatar src='/assets/twitter-avatar.jpg' alt='Whisper' />
          <div>
            <div className='flex gap-1'>
              <UserName verified name='Whisper' />
              <p className='text-light-secondary dark:text-dark-secondary'>
                @twitter
              </p>
            ...
            <p className='whitespace-pre-line break-words'>
              At the heart of Whisper are short messages called Whispers — just
